 ...
 */
package com.yy.bjtours.common.supcan;
...
import com.yy.bjtours.common.supcan.annotation.treelist.SupTreeList;
import com.yy.bjtours.common.supcan.annotation.treelist.cols.SupCol;
import com.yy.bjtours.common.supcan.annotation.treelist.cols.SupGroup;
import com.yy.bjtours.common.supcan.treelist.TreeList;
import com.yy.bjtours.common.supcan.treelist.cols.Col;
import com.yy.bjtours.common.supcan.treelist.cols.Group;
import com.yy.bjtours.common.utils.CacheUtils;
import com.yy.bjtours.common.utils.SpringContextHolder;
...
public class SupcanController extends BaseController {
	...
	public TreeList treeList(@PathVariable("typeAlias") String typeAlias) {
		...
		try{
			...
			logger.error("SupcanController treeList error:", e);
			// 取不到类型，返回空。
			return null;
		}
		...
		Comparator<Object> comparator = new Comparator<Object>() {
			...
			public int compare(Object o1, Object o2) {
				...
				return Integer.valueOf(sort1).compareTo(Integer.valueOf(sort2));
			}
		};
