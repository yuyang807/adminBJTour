 ...
 */
@MyBatisDao
public interface PicDao extends CrudDao<TPicDto>{

	List<TPicDto> findPicByLineNo(long lineNo);

	int updateByPicNo(TPicDto picDto);

	List<TPicDto> findAllPicList(String urlFront);
