...
import com.yy.bjtours.modules.web.dao.AdditionDao;
...
public class AdditionService extends CrudService<AdditionDao, TAdditionDto> {
     ...
     * @return
     */
    public List<TAdditionDto> queryAddList(TAdditionDto addDto){
    	return dao.findAllList(addDto);
    }
     ...
     * @return
     */
    public List<TAdditionDto> queryAdditionByLineNo(long lineNo){
    	return dao.findAddByLineNo(lineNo);
    }
	
    @Transactional(readOnly = false)
    public int updatePic(TAdditionDto addDto){
    	return dao.updateByAddNo(addDto);
    }
