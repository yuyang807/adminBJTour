...
public class LineService extends CrudService<LineDao, TLineDto> {
     ...
     * @return
     */
    public List<TLineDto> queryLineList(TLineDto lineDto){
    	return dao.findAllList(lineDto);
    }
     ...
     * @return
     */
    public TLineDto queryLine(TLineDto lineDto){
    	return dao.get(lineDto);
    }

	public TLineDtoVo getLineVo(Long lineNo) {
		return dao.getLineVo(lineNo);
	}
