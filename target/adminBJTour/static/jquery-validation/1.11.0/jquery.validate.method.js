...
//校验url或ip地址
jQuery.validator.addMethod("urlOrIP",function(value, element) {
	var tel = /^((http|https|ftp)\:\/\/)?(((25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[1-9][0-9]|[0-9])\.){3}(25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[1-9][0-9]|[0-9])|([a-zA-Z0-9_\-\.])+\.(com|cn|net|org|edu|int|mil|gov|arpa|biz|aero|name|coop|info|pro|museum|uk|me))((:[a-zA-Z0-9]*)?\/?([a-zA-Z0-9\-\._\?\,\'/\\\+&amp;%\$#\=~])*)$/;
	return this.optional(element) || tel.test(value);
},"请输入正确URL或IP地址")
//校验域名
